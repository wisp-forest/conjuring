...
public class ConjuringParticleEvents {
    ...
    public static final ParticleSystem<Void> BREAK_BLOCK = MANAGER.register(Void.class, (world, pos, data) -> {
    ...
    public static final ParticleSystem<BlockPos> UNLINK_WEAVER = MANAGER.register(BlockPos.class, (world, pos, pedestal) -> {
    ...
    public static final ParticleSystem<Void> CONJURER_SUMMON = MANAGER.register(Void.class, (world, pos, data) -> {
    ...
    public static final ParticleSystem<Boolean> EXTRACTION_RITUAL_FINISHED = MANAGER.register(Boolean.class, (world, pos, successful) -> {
        Vec3d loc = pos.add(.5, .5, .5);
    ...
    public static final ParticleSystem<Direction> PEDESTAL_REMOVED = MANAGER.register(Direction.class, (world, pos, direction) -> {
    ...
    public static final ParticleSystem<BlockPos> LINK_SOUL_FUNNEL = MANAGER.register(BlockPos.class, (world, pos, offset) -> {
    ...
    public static final ParticleSystem<Void> SOULFIRE_FORGE_SOULS = MANAGER.register(Void.class, (world, pos, data) -> {
        ClientParticles.setParticleCount(3);
