...
public class BlockCrawler {
    ...
    public static void crawl(World world, BlockPos firstBlock, ItemStack breakStack, int maxBlocks) {
        ...
        blocksToCrawl.add(new CrawlData(world.getDimensionKey(), breakStack, foundBlocks));
    ...
    public static void tick(World world) {
        ...
        for (CrawlData data : blocksToCrawl) {
            ...
            if (!data.world.getLocation().equals(world.getDimensionKey().getLocation())) continue;
            ...
            ServerParticles.issueEvent((ServerWorld) world, pos, new ResourceLocation("conjuring", "break_block"), packetByteBuf -> {});
        }
    }
