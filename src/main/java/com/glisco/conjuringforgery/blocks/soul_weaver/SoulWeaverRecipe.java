...
public class SoulWeaverRecipe implements IRecipe<Inventory> {
    ...
    public SoulWeaverRecipe(ResourceLocation id, ItemStack result, NonNullList<Ingredient> inputs, boolean transferTag) {
        this.id = id;
        this.result = result;
        this.inputs = inputs;
    ...
    public ItemStack getIcon() {
        return new ItemStack(ConjuringForgery.SOUL_WEAVER.get());
    }
    ...
    public static class Type implements IRecipeType<SoulWeaverRecipe> {
        private Type() {
        }

        public static final Type INSTANCE = new Type();

        public static final ResourceLocation ID = new ResourceLocation("conjuring", "soul_weaving");
    }
}
